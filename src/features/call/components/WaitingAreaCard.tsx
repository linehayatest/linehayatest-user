  ...
  const cards = [
    ...
    (
      <VStack h="full" w="full" px="2" justifyContent="center" fontSize="24px" fontFamily="quicksand" fontWeight="800" textAlign="center">
        ...
        <Text fontSize={["16px", "24px"]}>Note: Every call is appointed at an approximate 20 minutes</Text>
      </VStack>
    ),
    // Card 3
    (
      ...
      >
        ...
        <VStack fontSize="18px" w="100%" px="4" justifyContent="center">
          ...
          <UnorderedList w={["auto", "480px"]} textAlign="left">
            ...
            <ListItem>Silence is allowed if you need some time to put your thoughts together</ListItem>
          </UnorderedList>
